...
import 'package:testgetcli/app/modules/Profile/controllers/profile_controller.dart';
...
void main() async {
  ...
  Get.put(HomeController(), permanent: true); // Add this line first
  Get.put(FavoriteController(), permanent: true); // Then this line
  Get.put(ProfileController(), permanent: true); // Finally this line
